...
print(f"Found {len(brands)} brands and {len(processors)} processors")
...
def predict():
    try:
        ...
        try:
            ...
            input_data['Brand'] = [0]  # First brand in encoder
            input_data['Processor'] = [0]  # First processor in encoder
